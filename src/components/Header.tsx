      ...
      <div className="site-container">
        <div className="flex justify-between items-center py-4">
          ...
          <nav className="hidden md:flex space-x-8">
            ...
            <div className="relative group">
              <button className="nav-link"><span className="nav-text">Events</span></button>
        ...
        {isOpen && (
          <div className="md:hidden">
              ...
              <Link href="/about" className="nav-link block px-3 py-2"><span className="nav-text">About Us</span></Link>
              <div className="px-3 py-2">
                ...
                <div className={`${isEventsOpen ? 'block' : 'hidden'} pl-4 mt-1`}>
                  <Link href="/events/cqta" className="nav-link block pl-4 py-1"><span className="nav-text">CQTA Events</span></Link>
                  <Link href="/events/partner" className="nav-link block pl-4 py-1"><span className="nav-text">Partner Events</span></Link>
                </div>
              </div>
              <Link href="/partnership" className="nav-link block px-3 py-2"><span className="nav-text">Partnership</span></Link>
              <Link href="/sponsorship" className="nav-link block px-3 py-2"><span className="nav-text">Sponsorship</span></Link>
              <Link href="/contact" className="nav-link block px-3 py-2"><span className="nav-text">Get in Touch</span></Link>
            </nav>
          </div>
        )}
      </div>
